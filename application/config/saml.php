...
return [
    'sp' => [
        'entityId' => 'arsip.uns.ac.id', // domain publik / nama aplikasi anda
        'assertionConsumerService' => [
            'url' => 'http://localhost:8088/ci-view1/index.php/saml/acs', // url ke action acs di controller saml
            'binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST',

        ],
        'singleLogoutService' => [
            'url' => 'http://localhost:8088/ci-view1/index.php/saml/logout', // url ke action logout di controller saml

...
<?php } ?>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-primary text-uppercase fixed-top py-1" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="<?php echo base_url(); ?>homepage">UPT KEARSIPAN</a>               

                <ul class="navbar-nav" >
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded"style="text-decoration: none; " href="<?php echo base_url(); ?>pabout">About</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded"style="text-decoration: none; " href="<?php echo base_url('pabout/profil'); ?>">Profil</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" style="text-decoration: none" href="<?php echo base_url(); ?>pberita">Berita</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="<?php echo base_url(); ?>palbum">Album</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="<?php echo site_url('p_arsip_tekstual'); ?>">Arsip</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="<?php echo base_url(); ?>pregulasi">Regulasi</a></li>
                        ...
                        <li>
                            ...
                            <div class="middle">
                                    ...
                                    <input type="text" id="myinput" name="keyword" value="" placeholder="search...">
                                    <button type="button" class="btn" name="button" data-target="<?php echo base_url(); ?>pberita/search"></button>

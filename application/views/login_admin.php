                        ...
                        <div class="row">
                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                 ...
                                 <form class="admin" method="POST" action="<?php echo base_url(). 'login_admin/cek' ?>">                  
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                aria-describedby="emailHelp"
                                                placeholder="Masukkan Username Anda" name="username_administrator">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                 placeholder="Masukkan Password Anda" name="password_administrator">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <!-- <div class="text-center">
                                        <a class="small" href="<?php echo site_url('register_admin'); ?>">Create an Account!</a>
                                    </div> -->
                                </div>
                            </div>
                        </div>

	...
	<?php //foreach($artikel as $artkl) 	{	 ?>
		...
		<!--  inputan -->   
			<div class="form-group">
				...
				<input type="text"  name="jenis_artikel" class="form-control" value="">	
			</div>

			<div class="form-group">
			<label>gambar</label>			
			<input type="file" id="gambar" name="gambar" accept="image/*" class="form-control" value="" >	
				<!--  -->
			</div>
			...
			<div class="form-group">
				...
				<input type="date" id="tgl_publikasi_artikel" name="tgl_publikasi_artikel" class="form-control" value="">	
			</div>

			<div class="form-group">
				<label>Judul_Artikel</label>				
				<input type="text" id="judul_artikel" name="judul_artikel" class="form-control" value="">				
			</div>

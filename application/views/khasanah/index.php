...
<?php
$this->load->view('khasanah/popup/display');
$this->load->view('khasanah/popup/edit');
$this->load->view('khasanah/popup/add');
$this->load->view('khasanah/popup/delete');
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery('#staffListing').dataTable({
            ...
            "order": [],            
            "ajax": {
                "url": baseurl+"khasanah/getStaffListing",
                "type": "POST",
                "data": function ( data ) {

...
class M_regulasi extends Ci_Model{
	public function tampil_data()
	{
		...
		return $this->db->get('tb_regulasi');	// lalu buat view user
	}

	public function input_data($data,$table)
        {
                $this->judul_regulasi          = $data['judul_regulasi']; // please read the below note
                
                $this->file_regulasi           = $data['file_regulasi'];
    ...
    $this->db->from('tb_regulasi');  // manggil nama tb nya
    // manggil setipa nama field yanga ada di tabel artikel
    $this->db->like("lower(judul_regulasi)", strtolower($keyword));      // untuk field jenis artikel, dengan kunci keyword.
    $this->db->or_like("lower(file_regulasi)", strtolower($keyword));
    ...
    public function get_data($limit, $start){
        $query = $this->db->get('tb_regulasi', $limit, $start);
        return $query;

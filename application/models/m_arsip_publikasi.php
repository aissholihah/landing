<?php 
class M_arsip_publikasi extends Ci_Model{
	public function tampil_data()
	{
		// memanggil data di database tb_user
		return $this->db->get('tb_arsip_publik');	// lalu buat view user
	}
    ...
    $this->db->from('tb_arsip_publik');  // manggil nama tb nya
    // manggil setipa nama field yanga ada di tabel artikel
    $this->db->like("lower(judul_arsip)", strtolower($keyword));      // untuk field jenis artikel, dengan kunci keyword.
    $this->db->or_like("lower(tgl_publikasi_arsip)", strtolower($keyword));
    $this->db->or_like("lower(unit_kerja)", strtolower($keyword));
    $this->db->or_like("lower(file_arsip)", strtolower($keyword));
    ...
    public function get_data($limit, $start){
        $query = $this->db->get('tb_arsip_publik', $limit, $start);
        return $query;
